...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const numberOfDaysInMonth = (0, _dateFns.getDaysInMonth)(new Date(year, month - 1)); // Cria um array com o tamanho de dias do mes
    ...
    const availability = eachDayArray.map(day => {
      ...
      }); // Compara menor que 10 pois existem 10 agendamentos
      // no dia das 8 até as 17 levando em conta 1 hora cada agendamento
