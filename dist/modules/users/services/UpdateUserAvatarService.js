...
let UpdateUserAvatarServer = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    user.avatar = filename; // Save: ele cria um usuario se n tiver um usuario, se tiver um id ele atualiza
...
var _default = UpdateUserAvatarServer;
